...
import { Lupa, YellowLogo } from "../../icons/Icons";
    ...
    return (
        <div>
            <section className="excanations-wrapper">
                <div className="top-panel_light">
                    <div className="top-panel_light__logo"><YellowLogo /></div>
                    <div className="top-panel_light__links">
                        <Link className="top-panel_light__link" to={""}>Главная</Link>
                        <Link className="top-panel_light__link" to={"/news"}>Новости</Link>
                        <Link className="top-panel_light__link" to={"/monuments"}>Памятники</Link>
                        <Link className="top-panel_light__link" to={"/people"}>Люди</Link>
                        <Link className="top-panel_light__link" to={"/excavations"}>Раскопки</Link>
                    </div>
                    <div className="top-panel_light__lupa"><Lupa /></div>
                </div>
                <div className="buttons-wrapper">
                    <Button colors={ButtonColorTypes.Yellow} type={ButtonTypes.Linked} content={{
                        contentType: ButtonContentTypes.Text,
                        text: "Записаться на раскопки"
                    }} />
                    <Button colors={ButtonColorTypes.Transparent} type={ButtonTypes.Linked} content={{
                        contentType: ButtonContentTypes.Text,
                ...
                <div className="title-wrapper">
                    <h1 className="title-wrapper__title">
                        Привет! На этой страничке ты сможешь:
                    </h1>
                    <ul className="title-wrapper__subtitle-list">
                        <li className="title-wrapper__subtitle">
                            узнать что такое археология
                        </li>
                        <li className="title-wrapper__subtitle">
                            увидеть как проходит экспедиция
                        </li>
                        <li className="title-wrapper__subtitle">
                            записаться на раскопки
                        </li>
                        <li className="title-wrapper__subtitle">
                            узнать чем занимаются археологи после полевого сезона
                        </li>
                    </ul>
                </div>
                <div className="archeology-wrapper">
                    <p className="archeology-wrapper__text">
                        Археология это наука, изучающая быт и культуру древних народов по сохранившимся вещественным памятникам. <br />
                        И у тебя есть уникальная возможность поехать в экспедицию
                        и попробовать себя в роли археолога!</p>
                </div>
                <div className="excavations-info-wrapper">
                    <h1 className="excavations-info-wrapper__title">Как проходит экспедиция</h1>
                    <p className="excavations-info-wrapper__text">Каждое место индивидуально и нужен разный подход. Иногда мы копаем могильник на острове, иногда - городище в лесу. Но можно выделить 6 частей, на которые делится каждая экспедиция:  </p>
                    <Step
                        number={"1"}
                        title={"Установка лагеря"}
                        text={"Это как настоящее приключение! Мы приезжаем на место экспедиции, разбиваем палатки, расставляем оборудование и готовимся к работе."}
                    ...
                    <Step
                        ...
                        text={"Важный этап, где мы определяем место будущих раскопок. Мы отмечаем границы памятника и очищаем его сверху от растительности "}
                    ...
                    <Step
                        number={"3"}
                        title={"Раскопки"}
                        text={"Вот где начинается самое увлекательное! Мы аккуратно раскапываем землю, ищем артефакты для дальнейшего изучения марийской культуры. Каждая находка - это маленькое открытие, которое приближает нас к пониманию прошлого."}
                    ...
                    <Step
                        ...
                        text={"Этот этап заключительный, но такой же важный, как и остальные. Мы осторожно закрываем раскопки, возвращая местности ее первозданный вид. Это важно для сохранения целостности места и его исторической ценности."}
                    ...
                    <Step
                        number={"5"}
                        title={"Посвящение"}
                        text={"Мы любим делиться своим опытом с новыми участниками и посвящаем в археологи тех, кто впервые участвует в экспедиции. Удивительно, но посвящение всегда проходит по-разному!"}
                    ...
                    <Step
                        ...
                        text={"Это всегда немного грустно, но и волнительно. Мы собираем вещи, прощаемся с местом экспедиции и отправляемся домой. Но знаем, что в следующем году обязательно вернемся!"}
                ...
                <div className="volunteering-wrapper">
                    ...
                    <div className="volunteering-wrapper__table">
                        <div className="volunteering-wrapper__table__element">
                            <div className="volunteering-wrapper__table__element__title">
                                Рабочая группа
                            </div>
                            <div className="volunteering-wrapper__table__element__text">
                                Это наши самые отважные и усердные участники. Они проводят дни с лопатами и великолепно справляются с трудностями раскопок.
                            </div>
                        ...
                        <div className="volunteering-wrapper__table__element">
                            ...
                            <div className="volunteering-wrapper__table__element__text">
                                Эти волонтеры помогают археологам в работе с артефактами. Они очищают и документируют найденные предметы, играя важную роль в изучении нашей культуры.
                            </div>
                        ...
                        <div className="volunteering-wrapper__table__element">
                            ...
                            <div className="volunteering-wrapper__table__element__text">
                                Каждый день выбирается пара волонтеров, которые остаются на кухне и готовят для всех участников экспедиции. Эти волонтеры создают атмосферу уюта в нашем лагере.
                            </div>
